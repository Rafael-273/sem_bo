import codecs
from .models import Procedure, Occupation, Record, Cid, Procedure_has_cid, Procedure_has_occupation, Procedure_has_record
...
class DataImporter:
    ...
    def import_procedure_has_cid_data(file):
        ...
        for linha in content_str.split('\n'):
            ...
            procedure_has_cid = Procedure_has_cid(
    ...
    def import_procedure_has_occupation_data(file):
        ...
        for linha in content_str.split('\n'):
            ...
            procedure_has_occupation = Procedure_has_occupation(
                competence_date=dt_competencia,
                procedure=procedure,
    ...
    def import_procedure_has_record_data(file):
        ...
        for linha in content_str.split('\n'):
            ...
            procedure_has_record = Procedure_has_record(
                competence_date=dt_competencia,
                procedure=procedure,
                record=record
            )
